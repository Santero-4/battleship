# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 09:41:07 2024
...
def display_battle_chars(turns, special, last, fail, last_use, bomb):
    ...
    if difficulty_level == 'hard':
        ...
        spvox_win = 'Fear the might of the British Navy!'
        spvox_fail = 'Hmph... Consider yourself lucky...' 
    if not special:
        if last == 'phit' and turns%2 ==0:
            v = vox_phit
        elif last == 'pmiss' and turns %5 == 0:
            v = vox_pmiss
        elif last == 'ehit':
            v = vox_ehit
        elif last == 'emiss' and turns%3 ==0 :
            v = vox_emiss
        else:
            return -1
    if special:
        ...
        if fail == 1:
            v = spvox_fail
    # if v == vox_pmiss or v == vox_emiss:
    #     return -1
    if eships == 1 and (v == vox_pmiss or v == spvox_win):
        v = spvox_fail
    if pships == 1 and (v == vox_emiss or v == spvox_fail):
        v = vox_ehit
    ...
    # vox.undraw()
    # char.undraw()
    return [bomb, vox, talk_box, char, tstart]
